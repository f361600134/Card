 ...
 */
public abstract class TbDbGemCopyPo extends BasePo {
	...
	/** 今日已通关的层级列表:[level,level] */
	private java.lang.String passedLevels = null;
	/** 已通关副本id列表:[id,id] */
	...
	/** get 今日已通关的层级列表:[level,level] */
	public java.lang.String getPassedLevels() {
		return passedLevels;
	}

	/** set 今日已通关的层级列表:[level,level] */
	public void setPassedLevels(java.lang.String passedLevels) {
	...
	@Override
	public String[] props() {
		return new String[] {"`playerId`", "`remainCount`", "`passedLevels`", "`stageInfo`", "`resetTime`", "`isDel`"};
	}

	@Override
	public Object[] propValues() {
		return new Object[] { getPlayerId(), getRemainCount(), getPassedLevels(), getStageInfo(), getResetTime(), getIsDel() };
	}
