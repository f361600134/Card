package com.fatiny.cardlogin.interceptor;
...
import com.fatiny.cardlogin.common.config.DefineConfig;
...
import com.fatiny.cardlogin.util.HttpClientUtil;
import com.fatiny.cardlogin.util.UrlUtil;
	...
	private boolean checkBlackList(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			if (StringUtils.equals(result, "false")) {
				IResult failed = AuthResult.build(ErrorCodeEnum.ERROR_FORBIDDEN_IP);
